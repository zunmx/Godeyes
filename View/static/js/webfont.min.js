 ...
 *
 * Licensed under the Apache.json License, Version 2.0 (the "License"); you may not
 ...
 * the License.
 */
/* Web Font Loader v1.6.16 - (c) Adobe Systems, Google. License: Apache.json 2.0 */
"use strict";
(function () {
    function aa(a, b, c) {
    ...
    O.prototype.start = function () {
        ...
        var b = this.a.k.document, c = this, d = p();
        a()
    };
    ...
    U.prototype.W = function (a) {
        var b = this.p;
        if (b.u) {
            var c = u(b.j, b.e.d(b.f, a.getName(), I(a).toString(), "active")), d = [],
    ...
    function ma(a) {
        0 == --a.P && a.Y && (a.ba ? (a = a.p, a.u && t(a.j, [a.e.d(a.f, "active")], [a.e.d(a.f, "loading"), a.e.d(a.f, "inactive")]), J(a, "active")) : K(a.p))
    };
    ...
    function oa(a, b, c) {
        var d = [], e = c.timeout;
        ga(b);
        var d = ia(a.q, c, a.a), f = new U(a.a, b, e);
        a.$ = d.length;
        b = 0;
    ...
    ta.prototype.parse = function () {
        for (var a = this.o.length, b = 0; b < a; b++) {
            ...
            if (2 <= c.length) {
                ...
                0 < f.length && (e = f);
                3 == c.length && (c = c[2], f = [], c = c ? c.split(",") : f, 0 < c.length && (c = ua[c[0]]) && (this.I[d] = c))
            }
