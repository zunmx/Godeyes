...
function ServerError(jnSrz1) {
    if (window["\x53\x74\x72\x69\x6e\x67"](jnSrz1)['\x69\x6e\x64\x65\x78\x4f\x66']("\x47\x6f\x64\x45\x79\x65\x73\u670d\u52a1\u5668\u9519\u8bef") !== -1) {
        swal({
            title: "\x47\x6f\x64\x45\x79\x65\x73\u670d\u52a1\u5668\u9519\u8bef",
            text: '\u670d\u52a1\u5668\u9519\u8bef\uff0c\u8bf7\u8054\u7cfb\u7f51\u7ad9\u7ba1\u7406\u5458\uff0c\u7ec6\u8282\u89c1\u65e5\u5fd7\u3002\u5982\u679c\u662f\u957f\u65f6\u95f4\u672a\u64cd\u4f5c\uff0c\u8bf7\u91cd\u65b0\u767b\u5f55\u7cfb\u7edf\u3002',
            icon: "\x65\x72\x72\x6f\x72",
            button: true,
            closeOnClickOutside: false,
            closeOnEsc: false
        });
        console['\x6c\x6f\x67']("\x45\x52\x52\x4f\x52");
        throw"\x47\x6f\x64\x45\x79\x65\x73\u670d\u52a1\u5668\u9519\u8bef";
    }
}

function ajax_getInfo(RnTlfG2, NmEmyZ$v3 = null, lvV4 = null, zspgESaIk5 = null, G$6 = null) {
    $("\x23\x47\x45\x73\x79\x73\x74\x65\x6d\x2d\x73\x74\x61\x74\x75\x73")['\x68\x74\x6d\x6c']("\u7cfb\u7edf\u54cd\u5e94\u4e2d\x2e\x2e\x2e");
    var fMKebou7 = $['\x44\x65\x66\x65\x72\x72\x65\x64']();
    $['\x61\x6a\x61\x78']({
        type: "\x67\x65\x74",
        url: "\x67\x65\x74\x5f\x64\x61\x74\x61",
        data: {
            "\x72\x65\x71": RnTlfG2,
            "\x63\x6f\x64\x65": NmEmyZ$v3,
            "\x61\x72\x67\x31": lvV4,
            "\x61\x72\x67\x32": zspgESaIk5,
            "\x61\x72\x67\x33": G$6
        },
        timeout: 600000,
        xhrFields: {withCredentials: true},
        crossDomain: true,
        success: function (cYJSA8) {
            fMKebou7['\x72\x65\x73\x6f\x6c\x76\x65'](cYJSA8);
            $("\x23\x47\x45\x73\x79\x73\x74\x65\x6d\x2d\x73\x74\x61\x74\x75\x73")['\x68\x74\x6d\x6c']("\u7cfb\u7edf\u8fd0\u884c\u4e2d\x2e\x2e\x2e")
        }
    });
    return fMKebou7['\x70\x72\x6f\x6d\x69\x73\x65']()
}

function ajax_setInfo(AZ9, tHInJStY10 = null, kQgB_11 = null, sobjH_bI_12 = null, oQ13 = null) {
    $("\x23\x47\x45\x73\x79\x73\x74\x65\x6d\x2d\x73\x74\x61\x74\x75\x73")['\x68\x74\x6d\x6c']("\u7cfb\u7edf\u54cd\u5e94\u4e2d\x2e\x2e\x2e");
    $['\x61\x6a\x61\x78\x53\x65\x74\x75\x70']({data: {csrfmiddlewaretoken: $['\x63\x6f\x6f\x6b\x69\x65']('\x63\x73\x72\x66\x74\x6f\x6b\x65\x6e')}});
    var gOuezRBne14 = 1;
    $['\x61\x6a\x61\x78']({
        type: "\x70\x6f\x73\x74",
        url: "\x73\x65\x74\x5f\x64\x61\x74\x61",
        async: false,
        data: {
            "\x72\x65\x71": AZ9,
            "\x63\x6f\x64\x65": tHInJStY10,
            "\x61\x72\x67\x31": kQgB_11,
            "\x61\x72\x67\x32": sobjH_bI_12,
            "\x61\x72\x67\x33": oQ13
        },
        xhrFields: {withCredentials: true},
        crossDomain: true,
        success: function (wIQuYWZ15) {
            gOuezRBne14 = wIQuYWZ15;
            $("\x23\x47\x45\x73\x79\x73\x74\x65\x6d\x2d\x73\x74\x61\x74\x75\x73")['\x68\x74\x6d\x6c']("\u7cfb\u7edf\u8fd0\u884c\u4e2d\x2e\x2e\x2e")
        },
    });
    return gOuezRBne14
...
function ajax_dashBoardData_news(tp, ip, port, address, intime) {
    $("#dashboardData0").append("<tr>" + "<td>" + "<div class=\"flag\">" + "<img src=\"../static/imgs/" + tp + ".png\"alt=\"http(s)\" title='" + tp + "'>" + "</div>" + "</td>" + "<td>" + ip + "</td>" + "<td class=\"text-right\">" + port + "</td>" + "<td class=\"text-right\">" + address + "</td>" + "<td class=\"text-right\">" + intime + "</td>" + "</tr>")
};
...
function getScannerPorts(code, arg1, arg2) {
    $.when(ajax_getInfo("getScannerPorts", code, arg1)).done(function (rst) {
        $("#info_i").text("以下是针对于不同协议的端口号，每一行为一个端口号。");
        $("#info_i").css({
            color: "#8b92a9"
        });
        ServerError(rst);
...
function dataManager_addOper(swit, types, ip2port, address, text, time) { //防止返回数据对页面进行修改。
...
function dataManager_PageOper(func) {
    // reset \last \up \down \now
    let pg = $.cookie('pg');
    if (parseInt($.cookie('pg')) < 1) {
        $.cookie('pg', 1);
    } else if (parseInt($.cookie('pg')) >= parseInt($.cookie('lpg'))) {
        $.cookie('pg', (parseInt($.cookie('lpg'))));
    }
    if (parseInt($.cookie('lpg')) == 0) {
        return;
    }
    switch (func) {
        case "reset":
        ...
        case "up":
            ...
            if (pg === '1') {
                ...
                if ($.cookie('lpg') == 3) {
                    ...
                    setDataManagerPageNav((parseInt($.cookie('lpg')) - 2), (parseInt($.cookie('lpg')) - 1), (parseInt($.cookie('lpg'))), 2);
                    dataManager_item_oper(
                        $.cookie('innerSeleted'),
